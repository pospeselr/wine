...
static void clear_output_vars( const var_list_t *args )
{
  ...
  LIST_FOR_EACH_ENTRY( arg, args, const var_t, entry )
  {
      ...
      {
          if (type_get_type(type_pointer_get_ref(arg->decltype.type)->type) == TYPE_BASIC) continue;
          if (type_get_type(type_pointer_get_ref(arg->decltype.type)->type) == TYPE_ENUM) continue;
      }
